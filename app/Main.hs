...
-- TODO why a tuple instead of 2 args? bc newtype?
...
-- TODO replace by a suitable non-String type
type Err2 = String

evalInstance
  :: InstanceExp var ty sym en fk att gen sk x y
  -> Either Err2 (Instance var ty sym en fk att gen sk x y)
...
evalInstance (InstanceInitial schema) = pure $ Instance schema
